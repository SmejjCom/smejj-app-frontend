export const Icons = Object.freeze({
  ...
  automation: '<svg viewBox="0 0 24 24"><path d="M13 2 5 13h6l-1 9 8-12h-6l1-8Z"/><path d="M18 15.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5Z"/><path d="M18 14v1.5"/><path d="M18 20.5V22"/><path d="M14 18h1.5"/><path d="M20.5 18H22"/></svg>',
  ...
  account: '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="9" r="3"/><path d="M6.8 19a6 6 0 0 1 10.4 0"/></svg>',
  cost: '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M15 8h-4a4 4 0 0 0 0 8h4"/><path d="M8 11h6"/><path d="M8 13h5"/></svg>',
